    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 31, 12, 29, 28, 444, DateTimeKind.Utc).AddTicks(770), false, "თბილისი", null },
                    { 2, new DateTime(2025, 1, 31, 12, 29, 28, 444, DateTimeKind.Utc).AddTicks(770), false, "ბათუმი", null },
                    { 3, new DateTime(2025, 1, 31, 12, 29, 28, 444, DateTimeKind.Utc).AddTicks(830), false, "ქუთაისი", null },
                    { 4, new DateTime(2025, 1, 31, 12, 29, 28, 444, DateTimeKind.Utc).AddTicks(830), false, "რუსთავი", null },
                    { 5, new DateTime(2025, 1, 31, 12, 29, 28, 444, DateTimeKind.Utc).AddTicks(830), false, "გორი", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelatedPersons_PersonId_RelatedPersonId",
